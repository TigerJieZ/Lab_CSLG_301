"""
Django settings for Lab_CSLG_301 project.
...
SECRET_KEY = '*sif@4fw98l9&5&d!7k)io4n%m$=@vo7v2-d@&=@#7=pxwy@rx'
...
ROOT_URLCONF = 'Lab_CSLG_301.urls'
...
WSGI_APPLICATION = 'Lab_CSLG_301.wsgi.application'
